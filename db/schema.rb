...
ActiveRecord::Schema.define(version: 2020_11_28_204549) do
  ...
  create_table "project_stages", force: :cascade do |t|
    ...
    t.index ["project_type_id"], name: "index_project_stages_on_project_type_id"
  end
  ...
  create_table "providers_groups", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "spec"
  ...
  create_table "tarifs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "city_id", default: 1
    t.index ["city_id"], name: "index_tarifs_on_city_id"
