...
(function() {
  ...
  $(document).ready(function() {
    $('#develop_project_id').chosen({
      width: '402px',
      disable_search: 'true'
    });
    $('.develops').on('click', 'span.check_img', function() {
      var checked, chk, dev_id;
      if ($(this).hasClass('checked')) {
        $(this).removeClass('checked');
        checked = false;
      } else {
    ...
    $('#develops_search').on('click', '.btn-group input', function() {
      $('.btn-group label.active').removeClass('active');
      $('.btn-group label.active .radio').removeClass('active');
      $(this).parent().parent().addClass('active');
    });
    return $('#develops_search input').keyup(function() {
      var c, isWordcharacter, s;
...
(function() {
  ...
  this.update_lead = function(lead_id) {
    return $.get('/leads/' + lead_id + '/edit', "", null, "script");
  };

  this.lead_query = function(lead_params) {
    var actual, dir, dir2, search, sort2, srt, url;
  ...
  $(document).ready(function() {
    ...
    $('.files').on('click', 'span.glyphicon-remove', function() {
      var del, file_id;
    ...
    $('.comments_box').on('click', 'span.btn_remove', function() {
      var del, lead_id, leadcomm_id;
      del = confirm('Действительно удалить?');
      if (!del) {
        return;
      }
    ...
    $('.container').on('click', 'span.sort-span', function() {
      var dir, srt;
      srt = $(this).attr('sort');
    ...
    $('.container').on('click', 'span.subsort', function() {
      var dir2, srt2;
      dir2 = $(this).attr('dir2');
    ...
    return $('.container').on('click', 'span.only_actual', function() {
      var actual;
      if ($(this).hasClass('active')) {
...
(function() {
  ...
  this.setLoc = function(loc) {
    var curLoc, e, l, navPrefix;
    navPrefix = '';
    curLoc = fixEncode(loc);
    l = (location.toString().match(/#(.*)/) || {})[1] || '';
    if (!l) {
  ...
  this.ajx2q = function(qa) {
    var c, enc, i, key, l, query;
    query = [];
    enc = function(str) {
      var e;
...
(function() {
  $(document).ready(function() {
    $('#style').chosen({
      ...
      return $.get('providers', $("#p_search").serialize(), null, 'script');
    });
    $('#budget').chosen({
      width: '240px',
      disable_search: true
...
(function() {
  $(document).ready(function() {
    return $('.tstatuses').on('click', 'span.check_img', function() {
      var checked, chk, status_id;
      if ($(this).hasClass('checked')) {
        $(this).removeClass('checked');
        checked = false;
      } else {
