...
RSpec.describe AbsencesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested absence as @absence" do
      absence = Absence.create! valid_attributes
      get :show, {:id => absence.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested absence as @absence" do
      absence = Absence.create! valid_attributes
      get :edit, {:id => absence.to_param}, valid_session
      expect(assigns(:absence)).to eq(absence)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Absence" do
        expect {
          post :create, {:absence => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved absence as @absence" do
        post :create, {:absence => invalid_attributes}, valid_session
        expect(assigns(:absence)).to be_a_new(Absence)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested absence" do
        absence = Absence.create! valid_attributes
        put :update, {:id => absence.to_param, :absence => new_attributes}, valid_session
        absence.reload
      ...
      it "assigns the requested absence as @absence" do
        absence = Absence.create! valid_attributes
        put :update, {:id => absence.to_param, :absence => valid_attributes}, valid_session
        expect(assigns(:absence)).to eq(absence)
      end
    ...
    context "with invalid params" do
      it "assigns the absence as @absence" do
        absence = Absence.create! valid_attributes
        put :update, {:id => absence.to_param, :absence => invalid_attributes}, valid_session
        expect(assigns(:absence)).to eq(absence)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested absence" do
      absence = Absence.create! valid_attributes
      expect {
        delete :destroy, {:id => absence.to_param}, valid_session
      }.to change(Absence, :count).by(-1)
    end
